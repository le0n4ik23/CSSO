...
namespace ImGui
{
    ...
    //  - without IMGUI_DISABLE_OBSOLETE_KEYIO (legacy support): you can still use your legacy native/user indices (< 512) according to how your backend/
...
enum ImGuiBackendFlags_
{
    ...
    ImGuiBackendFlags_HasMouseCursors       = 1 << 1,   // Backend Platform supports honoring GetMouseCursor() value to change the OS shape.
...
struct ImDrawList
{
    ...
    IMGUI_API void RenderText(ImFont* font, float size, ImVec2 pos, ImU32 color, const char* text, int flag, int offset);
