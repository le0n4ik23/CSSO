    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            else
            {
                ...
                bd->pd3dDevice->DrawIndexedPrimitive(D3DPT_TRIANGLELIST, cmd->VtxOffset + global_vtx_offset, 0, (UINT)cmd_list->VtxBuffer.Size, cmd->IdxOffset + global_idx_offset, cmd->ElemCount / 3);
            }
        }
