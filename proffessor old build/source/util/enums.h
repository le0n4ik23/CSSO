...
{
	inline float head = 4.0f;
	inline float chestarms = 1.0f;
	inline float stomachpelvis = 1.25f;
	inline float legs = 0.75f;
}
...
namespace WeaponData
{
	namespace Deagle
	{
		inline float MaxPlayerSpeed = 230.f;
		inline float Damage = 53.f;
		inline float Penetration = 2.f;
		inline float Range = 4096.f;
		inline float HeadMultiplier = 3.9f;
	}
}